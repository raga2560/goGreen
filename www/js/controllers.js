angular.module('starter.controllers', ['ngMap', 'ngCordova'])
        ...
        .controller('ListMapofObject', function ($scope, $state, $http, $timeout, $ionicConfig, $ionicModal,  Authentication, Objectdata, UserdataService, Mystorage, ionicMaterialMotion, ionicMaterialInk) {
...
// http://stackoverflow.com/questions/20584367/how-to-handle-resource-service-errors-in-angularjs
		...
		//http://pointdeveloper.com/how-to-add-social-sharing-for-your-ionic-app/
    ...
    window.plugins.socialsharing.shareViaWhatsApp('goGreen App, for getting socially connected locally.', "www/img/gogreen_small.png" /* img */, 'https://play.google.com/store/apps/details?id=com.ionicframework.gogreen331421'  /* url */, null, function(errormsg){alert("Error: Cannot Share")});
  }
   $scope.twitterShare=function(){
    window.plugins.socialsharing.shareViaTwitter('goGreen App, for getting socially connected locally.', "www/img/gogreen_small.png" /* img */, 'https://play.google.com/store/apps/details?id=com.ionicframework.gogreen331421', null, function(errormsg){alert("Error: Cannot Share")});
  }
   $scope.OtherShare=function(){
     window.plugins.socialsharing.share('goGreen App, for getting socially connected locally.', null, "www/img/gogreen_small.png", 'https://play.google.com/store/apps/details?id=com.ionicframework.gogreen331421');
	 // $cordovaSocialSharing.share("This is your message", "This is your subject", "www/imagefile.png", "http://blog.nraboy.com");
  }
